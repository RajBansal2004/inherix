...
const items = [
  {
    ...
    subtitle: "Identity, nominee & profile records",
    icon: User,
    slug: "personal-information",
  },
  {
    title: "Financial Information",
    subtitle: "Banking, investments & wealth",
    icon: Landmark,
    slug: "financial-information",
  },
  {
    title: "Digital Assets",
    subtitle: "Passwords, domains & accounts",
    icon: Layers3,
    slug: "digital-assets",
  },
  {
    title: "Legal Documents",
    subtitle: "Will, agreements & certificates",
    icon: FolderOpen,
    slug: "legal-documents",
  },
  {
    title: "Property & Assets",
    subtitle: "Properties, vehicles & valuables",
    icon: Home,
    slug: "property-assets",
  },
  {
    title: "Others",
    subtitle: "Additional continuity information",
    icon: Shield,
    slug: "others",
  },
];
          ...
          <div className="max-h-[420px] space-y-3 overflow-y-auto pr-1">
            ...
            {items.map((item) => {
              ...
              return (
                <Link
                  key={item.slug}
                  href={`/dashboard/vault/add?category=${item.slug}`}
                  onClick={() => setOpen(false)}
